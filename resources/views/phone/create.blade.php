...
<div class="mt-5">
   <form method="post" action="{{route('phone.store')}}" class="max-w-md mx-auto">
    @method("POST")
    @csrf
            ...
            <div class="my-2">
                    ...
                    <label for="person_id" class="sr-only">Category</label>
                    <select name="person" id="person" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
